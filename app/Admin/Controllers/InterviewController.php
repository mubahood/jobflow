...
class InterviewController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->radio('stage', __('Did this candidate pass interview and ready for PRE GCC MEDICAL?'))
            ->options([
                'Medical' => 'Passed interviews',
                'Failed' => 'Failed interviews',
